...
![console 404 error](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="965"></svg>)
...
![vue build output](https://user-gold-cdn.xitu.io/2019/5/5/16a85d53776d87c2?imageslim)
...
![docker build vuenginxcontainer image](https://user-gold-cdn.xitu.io/2019/5/5/16a85d53cfa3f759?imageslim)
...
![docker grep image vuenginxcontainer](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="84"></svg>)
...
![vueApp container](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="78"></svg>)

可以发现名为 vueApp的容器已经运行起来。此时访问 [http://localhost:3000](http://localhost:3000/) 应该就能访问到该vue应用:

![vueApp index](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="846"></svg>)
...
构建镜像的时候 node\_modules 的依赖直接通过 `RUN npm install` 来安装，项目中创建一个 `.dockerignore`文件来忽略一些直接跳过的文件：
...
![docker build nodewebserver](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1001" height="640"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="102"></svg>)

可以发现 nodeserver 的容器也正常的运行起来。访问以下 [http://localhost:5000/json](http://localhost:5000/json) 能访问到前面写的json数据

![api json](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1080" height="458"></svg>)
...
![nodeserver ip](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="784" height="370"></svg>)
...
![nodeserver networks](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="604"></svg>)

记录下node服务容器对应的ip，一会儿配置nginx转发的时候会用到。

#### 6.2 修改 nginx 配置

- Nginx 配置 location 指向 node 服务 default.conf （[前端想要了解的Nginx](https://juejin.im/post/6844903816521842702)，关于Nginx的配置已经 location 的具体写法可以参考（[一文弄懂Nginx的location匹配](https://juejin.im/post/6844903828895039501)））
